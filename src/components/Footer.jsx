...
// when any link selected then other will blur code in footer
const Footer = () => {
    ...
    <>
        <footer>
            ...
            <aside onMouseLeave={linksBackToNormal} >
                ...
                <a href="/chaiwala" className="footerLinks" onMouseOver={()=>footerLinks(5)} data-cursorpointermini={true} >Chai Wala Cares</a>
            </aside>
